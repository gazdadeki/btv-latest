export const TEAM_NAMES = { A: 'Scourge', B: 'Sentinel' } as const;
...
export const RECURRENCE_TYPES = ['WEEKLY', 'MONTHLY', 'YEARLY', 'ONCE'] as const;
export const REFUND_POLICIES = ['FULL', 'PARTIAL', 'NONE'] as const;
export const WEEKDAYS = ['Mon', 'Tue', 'Wed', 'Thu', 'Fri', 'Sat', 'Sun'] as const;
export const WEEKDAY_LABELS_SUNDAY_FIRST = ['Sun', 'Mon', 'Tue', 'Wed', 'Thu', 'Fri', 'Sat'] as const;
