        ...
        <div className="space-y-4">
          <table className="w-full text-sm table-fixed">
            <tbody className="divide-y divide-gray-100">
              ...
              <tr>
                <td className="py-2 font-medium">Banned</td>
                <td>
                  {user.isBanned
                    ? `Yes${user.bannedUntil ? ` (until ${formatDate(user.bannedUntil)})` : " (Permanent)"}`
                    : "No"}
                </td>
              </tr>
              <tr>
          ...
          {Object.keys(stats).length > 0 && (
            <div className="flex gap-3 flex-wrap mt-3">
              ...
              {stats.losses !== undefined && (
                <div className="px-3 py-2 bg-red-50 rounded text-sm">
        ...
        <div className="space-y-4">
          ...
          <div className="border border-gray-200 rounded-lg p-3">
            ...
            <div className="flex gap-2">
              ...
              />
              <Button variant="success" size="sm" onClick={handleGrantCoins}>
                Grant
              </Button>
            </div>
          </div>
                ...
                {walletTxs.map((tx) => (
                  <tr key={tx.id}>
                    ...
                    <td className="px-3 py-2">
                      <span
                        className={`px-1.5 py-0.5 rounded text-xs ${tx.amount > 0 ? "bg-green-100 text-green-700" : "bg-red-100 text-red-700"}`}
                      >
                        {tx.type}
                      </span>
                    </td>
