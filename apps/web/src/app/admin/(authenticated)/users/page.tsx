      ...
      cell: (info) => {
        ...
        return (
          <div className="flex gap-1 flex-wrap">
            ...
            <Button variant="warning" size="xs" onClick={() => setEditUser(u)} title="Edit"><i className="fas fa-edit" /></Button>
            <Button variant="purple" size="xs" onClick={() => setStripeUser(u)} title="Stripe"><i className="fab fa-stripe-s" /></Button>
            {!u.isVerified && (
              <>
            ...
            {u.isBanned ? (
              ...
              <Button variant="danger" size="xs" onClick={() => setBanTarget(u.id)} title="Ban"><i className="fas fa-ban" /></Button>
            )}
