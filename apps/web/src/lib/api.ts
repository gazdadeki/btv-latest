...
export const api = {
  ...
  // Stripe
  getUserStripeInfo: (id: number) => apiRequest(`/admin/users/${id}/stripe`),
  ...
  adminRequestVerification: (id: number) =>
    apiRequest(`/verification/admin/users/${id}/request-verification`, {
      method: "POST",
    }),
  ...
  confirmAllSlots: (gameId: number) =>
    apiRequest<{ confirmedCount: number }>(
      `/admin/games/${gameId}/slots/confirm-all`,
      { method: "PUT" },
    ),
  cancelAllConfirmations: (gameId: number) =>
    apiRequest<{ cancelledCount: number }>(
  ...
  createStripeProduct: (data: Record<string, unknown>) =>
    apiRequest("/admin/stripe/products", {
      method: "POST",
      body: JSON.stringify(data),
    }),
  updateStripeProduct: (id: number, data: Record<string, unknown>) =>
    apiRequest(`/admin/stripe/products/${id}`, {
      method: "PUT",
      body: JSON.stringify(data),
    }),
  ...
  createTutorial: (data: Record<string, unknown>) =>
    apiRequest("/admin/tutorials", {
      method: "POST",
      body: JSON.stringify(data),
    }),
  updateTutorial: (id: number, data: Record<string, unknown>) =>
    apiRequest(`/admin/tutorials/${id}`, {
      method: "PUT",
      body: JSON.stringify(data),
    }),
  ...
  updateTutorialCategory: (id: number, data: Record<string, unknown>) =>
    apiRequest(`/admin/tutorials/categories/${id}`, {
      method: "PUT",
      body: JSON.stringify(data),
    }),
  ...
  getConversationMessages: (id: number, page?: number, limit?: number) => {
    ...
    return apiRequest(
      `/messages/conversations/${id}/messages${buildQuery(params)}`,
    );
  },
