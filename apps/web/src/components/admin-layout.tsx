...
const navItems = [
  ...
  { href: '/admin/subscriptions', label: 'Subscriptions', icon: 'fas fa-credit-card' },
  { href: '/admin/tutorials', label: 'Tutorials', icon: 'fas fa-book' },
  { href: '/admin/stripe-products', label: 'Stripe Products', icon: 'fas fa-shopping-cart' },
  ...
  return (
    <aside className="fixed left-0 top-0 h-full w-64 bg-gray-900 text-white flex flex-col z-40">
      <div className="h-16 flex items-center justify-center border-b border-gray-700">
        <Link href="/admin" className="text-xl font-bold text-white no-underline">
          BaltazarTV
        </Link>
      </div>
