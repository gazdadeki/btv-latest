...
- Table names: plural, snake_case (`@Entity('games')`, `@Entity('streams')`)
- Column names: camelCase (TypeORM default — no `name:` overrides used in this project)
- Primary key: `id` (auto-generated)
- Foreign keys: `*Id` pattern (`scheduleId`, `userId`, `streamId`)
